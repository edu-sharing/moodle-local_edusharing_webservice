...
$functions = [
    'local_edusharing_getcategories' => [ // local_PLUGINNAME_FUNCTIONNAME is the name of the web service function that the client will call.
    ...
    'local_edusharing_restore'       => [ // local_PLUGINNAME_FUNCTIONNAME is the name of the web service function that the client will call.
        'classname'    => 'local_edusharing_webservice_external', // create this class in local/PLUGINNAME/externallib.php
    ...
    'local_edusharing_createempty'   => [ // local_PLUGINNAME_FUNCTIONNAME is the name of the web service function that the client will call.
        'classname'    => 'local_edusharing_webservice_external', // create this class in local/PLUGINNAME/externallib.php
    ...
    'local_edusharing_handleuser'    => [ // local_PLUGINNAME_FUNCTIONNAME is the name of the web service function that the client will call.
        'classname'    => 'local_edusharing_webservice_external', // create this class in local/PLUGINNAME/externallib.php
    ...
    'local_edusharing_scorm'         => [ // local_PLUGINNAME_FUNCTIONNAME is the name of the web service function that the client will call.
        'classname'    => 'local_edusharing_webservice_external', // create this class in local/PLUGINNAME/externallib.php
    ...
    'local_edusharing_ping'          => [ // local_PLUGINNAME_FUNCTIONNAME is the name of the web service function that the client will call.
        'classname'    => 'local_edusharing_webservice_external', // create this class in local/PLUGINNAME/externallib.php
